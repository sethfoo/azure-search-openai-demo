...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping user create thinkscript code. " \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching code database and creating thinkscript code and understanding candlesticks."
